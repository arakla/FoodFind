...
class EventTest < ActiveSupport::TestCase
  ...
  should allow_value(DateTime.current).for(:start_time)
  should allow_value(1.day.ago.to_datetime).for(:start_time)
  should allow_value(1.day.from_now.to_datetime).for(:start_time)
  ...
  should allow_value(DateTime.current).for(:end_time)
  should allow_value(1.day.ago.to_datetime).for(:end_time)
  should allow_value(1.day.from_now.to_datetime).for(:end_time)
